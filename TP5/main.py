...
def main() -> CompteTikTok:
    ...
    chapeau = Accessoire("mon chapeau ",4, TypeAccessoire.CHAPEAU)   


    # TODO : Creer un objet Accessoire de type chaussures avec un niveau de mignonnerie de 6
    chaussures = Accessoire("mon chaussures",6, TypeAccessoire.CHAUSSURES) ### Manque NOM
    ...
    vues_tiktok_3 = tiktok3.vues  # Pas sure si on ajoute () ou pas
    ...
    vues_compte = compte.vues   # Pas sure si on ajoute () ou pas
